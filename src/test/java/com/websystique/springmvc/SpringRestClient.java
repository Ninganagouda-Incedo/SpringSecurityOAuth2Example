...
public class SpringRestClient {
    ...
    public static final String REST_SERVICE_URI = "http://localhost:8083/SpringSecurityOAuth2Example";
    
    public static final String AUTH_SERVER_URI = "http://localhost:8083/SpringSecurityOAuth2Example/oauth/token";
	...
	private static AuthTokenInfo sendTokenRequest(){
        ...
        System.out.println(AUTH_SERVER_URI+QPM_PASSWORD_GRANT);
    ...
    private static void listAllUsers(AuthTokenInfo tokenInfo){
        ...
        System.out.println(REST_SERVICE_URI+"/user/"+QPM_ACCESS_TOKEN+tokenInfo.getAccess_token());
